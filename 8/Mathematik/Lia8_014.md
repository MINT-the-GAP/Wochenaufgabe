...
\dfrac{8}{3} x + \dfrac{3}{2} &\stackrel{!}{=}  \dfrac{5}{8} \quad \left| -\dfrac{3}{2} \right. \\
\dfrac{8}{3} x &\stackrel{!}{=}  -\dfrac{7}{8} \quad \left|  \cdot \dfrac{3}{8} \right. \\
x &= \dfrac{7}{3}  
\end{align*}
$$
************
...
<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
$h(x)=$ [[     -1/2*x-5/8     ]] @canvas
@Algebrite.check(-1/2*x-5/8)
************
$$
\begin{align*}
g\left( x = -\dfrac{1}{2} \right) = -2 \cdot \left( -\dfrac{1}{2} \right) + \dfrac{5}{8} = - \dfrac{3}{8}
\end{align*}
$$
$$
\begin{align*}
...
\begin{align*}
h(x) & = m_h x + n_h \\
- \dfrac{3}{8} & = -\dfrac{1}{2} \cdot \left( -\dfrac{1}{2} \right) + n_h  \quad \left| - \dfrac{1}{4} \right. \\
- \dfrac{5}{8} & = n_h  \quad \left| - \dfrac{1}{4} \right. \\
\Rightarrow\;\; h(x) & = -\dfrac{1}{2}x - \dfrac{5}{8}
\end{align*}
$$
************
