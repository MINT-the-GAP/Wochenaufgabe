...
# Aufgaben für die Prüfungstage - Physik: Klasse 6
...
$a)\;\;$  **Ordne** das Zeichnen einer Reflexion von Licht an einer gekrümmten spiegelnden Oberfläche.


<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
Erster Schritt: [->[ (Verlängere den Lichtstrahl bis dieser auf die Oberfläche trifft.) ]] \
Zweiter Schritt: [->[ (Zeichne eine Tangente als Näherung für die Spiegelung.) ]] \
Dritter Schritt: [->[ (Zeichne das Lot ein.) ]] \
Vierter Schritt: [->[ (Miss den Einfallswinkel.) ]] \
Fünften Schritt: [->[ (Zeichne den Ausfallswinkel.) ]] \
...
$b)\;\;$ **Kreuze an**, ob die Aussage "wahr", "falsch" oder "nicht entscheidbar" ist.
...
- [ ( )       (X)             ( )     ]  Im Winter ist die Sonne weiter von der Erde entfernt.
- [ (X)       ( )             ( )     ]  In einem Lichtkegel verteilen sich die Lichtstrahlen auf einer auf, sodass in der Entfernung das Licht weniger hell wirkt.
- [ (X)       ( )             ( )     ]  Eine Sonnenfinsternis kann nur beim Neumond vorkommen.
- [ ( )       (X)             ( )     ]  Der Winkel zum Lot wird größer, wenn Licht von Luft in Glas übergeht.
- [ ( )       (X)             ( )     ]  Der Mond ist eine Lichtquelle.
- [ (X)       ( )             ( )     ]  Wir können einen Gegenstand sehen, wenn Licht von ihm in unser Auge reflektiert wird.
- [ ( )       (X)             ( )     ]  Schwarze Gegenstände reflektieren mehr Licht als weiße Gegenstände.
- [ ( )       ( )             (X)     ]  Der Schatten auf dem Schirm ist größer als der beleuchtete Gegenstand.
...
Im folgenden Koordinatensystem ist eine Temperaturkurve dargestellt. **Gib** die Antworten auf die Fragen **an**.


<center>
<!-- style="max-width:700px" -->
![](https://raw.githubusercontent.com/MINT-the-GAP/Wochenaufgabe/refs/heads/main/Zeug/Temperaturkurve.PNG)
</center>
...
__$a)\;\;$__ Wie hoch ist die Temperatur nach $8$ Stunden ungefähr?

<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   22,5   ]] $^\circ\text{C}$
@Algebrite.check2(22.5,0.5)

@ADetails(1=BE;Temperatur)
...
__$b)\;\;$__ Wie hoch ist die Temperatur nach $21$ Stunden ungefähr?

<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   21   ]] $^\circ\text{C}$
@Algebrite.check2(21,0.5)
...
__$c)\;\;$__ Nach welcher Zeit ist die Temperatur am höchsten?

<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   13,5   ]] $\text{h}$
@Algebrite.check2(13.5,0.15)
...
__$d)\;\;$__ Nach welchem Zeitpunkt ist die Temperatur bei $15^\circ\text{C}$?

<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   3,25   ]] $\text{h}$
@Algebrite.check2(3.25,0.15)
...
__$e)\;\;$__ Nach welchem Zeitpunkt ist die Temperatur bei $15^\circ\text{C}$?


<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   3,33   ]] $\text{h}$
@Algebrite.check2(3.33,0.15)
...
__$f)\;\;$__ Zu welcher Zeit ist die Temperatur genauso hoch wie nach $6{,}5$ Stunden?


<!-- data-solution-timer="300s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   21,5   ]] $\text{h}$
@Algebrite.check2(21.5,0.2)
...
Ein Quader mit den Kantenlängen $a=5\,$cm, $b=7\,$cm und $c=3\,$cm wurde aus  Titan mit einer Dichte von $4,54 \,\dfrac{\text{g}}{\text{cm}^3}$ hergestellt. 


__$a)\;\;$__ **Berechne** das Volumen des Quaders.
...
\begin{align*}
V & = a \cdot b \cdot c \\
 & =   5\,\text{cm}  \cdot 7\,\text{cm}  \cdot 3\,\text{cm}  \\
 & = 105\,\text{cm}^3 
\end{align*}
$$
**********************

@ADetails(2=BE;Dichte)


__$b)\;\;$__ **Berechne** die Masse der Quader und **gib** diese in Kilogramm **an**.


<!-- data-solution-timer="600s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->
[[   0,4767   ]] $\text{kg}$ @canvas
@Algebrite.check2(0.4767,0.001)
**********************
$$
\begin{align*}
m & = \rho \cdot V \\
  & =4,54 \,\dfrac{\text{g}}{\text{cm}^3} \cdot 105\,\text{cm}^3  \\
  & = 476,7\,\text{g} \\
  & = 0,4767\,\text{kg}
\end{align*}
$$
