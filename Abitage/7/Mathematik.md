...
# Aufgaben für die Prüfungstage - Mathematik: Klasse 7
...
**_Aufgabe 1:_** **Sortiere** das die Kacheln nach Größe und **ordne** sie der passenden Größe zu.
...
@ADetails(1=BE;Koordinatensystem,Rechteck)
...
**_Aufgabe 1:_** In der Backstube steht ein Mehlsack mit $24\,\text{kg}$.  
...
**_Aufgabe 2:_** Ein Behälter wird täglich mit vier Litern Wasser aufgefüllt. Zu Beginn sind bereits zwei Liter enthalten.  
