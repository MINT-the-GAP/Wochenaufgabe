...
comment: Dies ist die Wochenaufgabe 26 für die 5. Klasse im Fach Mathematik.
author: Martin Lommatzsch
-->

# Wochenaufgabe 26 Klasse 5 – Mathematik
...
@circleQuiz(3/4,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
...
@rectQuiz(2/5,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@circleQuiz(7/10,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@rectQuiz(5/6,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@circleQuiz(4/9,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@rectQuiz(11/12,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@circleQuiz(3/8,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@rectQuiz(5/12,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@circleQuiz(7/9,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@rectQuiz(9/10,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@circleQuiz(1/3,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
@rectQuiz(6/7,`<!-- data-solution-timer="450s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" data-hint-button="2" data-solution-button="3" -->`)
@ADetails(1=BE;Bruchrechnung)
...
[[ Folgen von Zahlen und Symbolen | Abschätzen von Mengen aus Bildern | Brüche darstellen | Vokabeln der Grundrechenarten | bei keinem Bereich ]]
