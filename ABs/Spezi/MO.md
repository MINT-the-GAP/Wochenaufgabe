...
<!-- lia-llm:criterion -->
Die Antwort stellt einen korrekten Größenbezug zwischen dem äußeren Quadrat und dem Kreis her, etwa dass die äußere Seitenlänge dem Kreisdurchmesser entspricht.
<!-- lia-llm:criterion -->
...
<!-- lia-llm:criterion -->
Der Flächeninhalt des inneren Quadrats wird im selben Maßstab korrekt bestimmt, etwa als $\frac{a^2}{2}$ bei äußerer Seitenlänge $a$ oder als $2r^2$ bei Kreisradius $r$; eine gleichwertige geometrische Flächendarstellung ist ebenfalls zulässig.
<!-- lia-llm:criterion -->
Aus dem Flächenvergleich wird allgemein gefolgert, dass der innere Flächeninhalt die Hälfte des äußeren beträgt; eine bloße Messung an einem Zahlenbeispiel genügt dafür nicht.
<!-- lia-llm:solution -->
